  ...
  return (
    <>
      <div className="relative bg-white z-[800] shadow">
        <h1
          className="text-center py-[4vh] lg:text-2xl lg:py-[4vh] 
        font-black text-xl"
        >
          UPCOMING SPECIAL PROGRAM
        </h1>
        <div
          className="grid lg:grid-cols-3 gap-[2vw] px-10 pb-10 lg:py-[1vh] 
        md:grid-cols-2
        "
        >
          {[eventMangementList[0], eventMangementList[1]].map((event) => {
            ...
            return (
              <div
                ...
                rounded-b-2xl cursor-pointer mb-10 lg:py-[4vh] lg:py-[4vh] lg:py-[4vh] "
              >
