  ...
  return (
    <>
      <div className="relative bg-white z-[800] shadow">
        <h1
          className="text-center py-[4vh] lg:text-2xl lg:py-[1%] 
        font-black text-xl"
        >
          UPCOMING SPECIAL PROGRAM
        </h1>
        <div
          className="grid lg:grid-cols-3 gap-[2vw] px-10 pb-10 lg:py-[1%]
        md:grid-cols-2
        "
        >
          {[eventMangementList[0], eventMangementList[1]].map((event) => {
            ...
            return (
              <div
                ...
                rounded-b-2xl cursor-pointer mb-10 lg:py-[4vh] lg:py-[1%]"
              >
                <img src={eventImageUrl} alt="" />
                <div className="p-5 lg:py-[1%]">
                  <h3 className="font-black lg:text-[1.5rem] text-center lg:py-[1%] font-['Arial']">
                    {eventName}
                  </h3>
                  <p className="text-center pb-[3vh] lg:px-[3vw] lg:py-[1%] font-bold">
                    Date:
                    {startDate === endDate
                      ? startDate
                      : { startDate } - { endDate }}
