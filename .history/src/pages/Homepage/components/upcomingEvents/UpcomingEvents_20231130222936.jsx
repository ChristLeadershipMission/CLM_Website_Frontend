  ...
  return (
    <>
      <div className="relative bg-white z-[800] shadow">
        <h1
          className="text-center py-4 lg:text-2xl lg:py-6 
          font-black text-xl"
        >
          UPCOMING SPECIAL PROGRAM
        </h1>
        <div
          className="grid lg:grid-cols-3 gap-4 px-4 pb-4
          md:grid-cols-2"
        >
          {[eventMangementList[0], eventMangementList[1]].map((event) => {
            ...
            return (
              <div
                ...
                rounded-b-2xl cursor-pointer mb-2"
              >
                <img src={eventImageUrl} alt="" />
                <div className="p-2">
                  <h3 className="font-black text-lg text-center pb-2">
                    {eventName}
                  </h3>
