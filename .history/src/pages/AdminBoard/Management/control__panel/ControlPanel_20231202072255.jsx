...
const ControlPanel = ({ hideSideBar }) => {
  ...
  return (
    <>
      <div className="  lg:w-[82%] h-[90vh] relative 
       bg-[url('/src/pages/AdminBoard/Minister/Images/clmLogo.svg')] bg-no-repeat bg-contain bg-center">
        <div className="bg-white shadow-lg lg:h-[10vh] lg:p-[.5rem] flex justify-around lg:block" shadow-lg>
